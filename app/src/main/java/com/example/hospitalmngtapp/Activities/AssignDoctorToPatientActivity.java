...
public class AssignDoctorToPatientActivity extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<User, MyViewHolder> adapter = new FirebaseRecyclerAdapter<User, AssignDoctorToPatientActivity.MyViewHolder>(options) {

            @Override
            protected void onBindViewHolder(@NonNull AssignDoctorToPatientActivity.MyViewHolder holder, final int position, @NonNull final User model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        View myView = inflater.inflate(R.layout.assignment_layout, null);
